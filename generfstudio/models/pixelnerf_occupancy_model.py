...
from pynerf.samplers.pynerf_vol_sampler import PixelNeRFVolumetricSampler

CONSOLE = Console(width=120)


@dataclass
class PixelNeRFOccupancyModelConfig(PixelNeRFBaseModelConfig):
    _target: Type = field(
        default_factory=lambda: PixelNeRFOccupancyModel
    )
...
class PixelNeRFOccupancyModel(PixelNeRFBaseModel):
    config: PixelNeRFOccupancyModelConfig
    ...
    def populate_modules(self):
        ...
        # Sampler
        self.sampler = PixelNeRFVolumetricSampler(
